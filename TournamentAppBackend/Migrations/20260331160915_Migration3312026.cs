...
{
    /// <inheritdoc />
    public partial class Migration3312026 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RefereeAssignments_Matches_MatchId",
                        column: x => x.MatchId,
                        principalTable: "Matches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RefereeAssignments_Users_RefereeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefereeAssignments_MatchId_RefereeId",
                table: "RefereeAssignments",
                columns: new[] { "MatchId", "RefereeId" },
                unique: true);
